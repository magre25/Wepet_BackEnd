...
INSERT INTO permissao (codigo, descricao) values (3, 'ROLE_CADASTRAR_ANIMAL');
INSERT INTO permissao (codigo, descricao) values (4, 'ROLE_PESQUISAR_ANIMAL');

INSERT INTO permissao (codigo, descricao) values (5, 'ROLE_CADASTRAR_SERVICO');
INSERT INTO permissao (codigo, descricao) values (6, 'ROLE_PESQUISAR_SERVICO');

INSERT INTO permissao (codigo, descricao) values (7, 'ROLE_CADASTRAR_PRESTADOR');
INSERT INTO permissao (codigo, descricao) values (8, 'ROLE_PESQUISAR_PRESTADOR');

INSERT INTO permissao (codigo, descricao) values (9, 'ROLE_CADASTRAR_PEDIDO');
INSERT INTO permissao (codigo, descricao) values (10, 'ROLE_PESQUISAR_PEDIDO');
